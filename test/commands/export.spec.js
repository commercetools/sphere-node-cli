...
describe('ExportCommand', () => {
  ...
  it('should initialize command', () => {
    ...
    expect(...spy1.args[0]).toEqual({}, 'type')
    expect(...spy2.args[0]).toEqual('Missing required options: type')
  })

  it('should process command', () => {
    const spy1 = sinon.stub(command, '_stream')
    const spy3 = sinon.stub(command, '_preProcess', opts => {
